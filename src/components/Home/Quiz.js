...
const Quiz = () => {
  ...
  if(question === arrayOfQuiz.length){
      setQuestion(0);
    }else{
  ...
  return (
    <Card>
      <form onSubmit={questionSubmitHandler}>
        <h4>{`Q${question+1}) ${arrayOfQuiz[question].question}`}</h4>
        <div>
          <input
            type="radio"
            name="answer"
            id="choice0"
            value={arrayOfQuiz[question].choices[0]}
          />
          <label htmlFor="choice0">{arrayOfQuiz[question].choices[0]}</label>
          <input
            type="radio"
            name="answer"
            id="choice1"
            value={arrayOfQuiz[question].choices[1]}
          />
          <label htmlFor="choice1">{arrayOfQuiz[question].choices[1]}</label>
          <input
            type="radio"
            name="answer"
            id="choice2"
            value={arrayOfQuiz[question].choices[2]}
          />
          <label htmlFor="choice2">{arrayOfQuiz[question].choices[2]}</label>
          <input
            type="radio"
            name="answer"
            id="choice3"
            value={arrayOfQuiz[question].choices[3]}
          />
          <label htmlFor="choice3">{arrayOfQuiz[question].choices[3]}</label>
        </div>
